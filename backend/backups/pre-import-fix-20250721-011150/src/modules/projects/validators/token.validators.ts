...
export const safeParseTokenCreate = (data: unknown) => tokenCreateSchema.safeParse(data);
export const safeParseTokenUpdate = (data: unknown) => tokenUpdateSchema.safeParse(data);
export const safeParseTokenListQuery = (data: unknown) => tokenListQuerySchema.safeParse(data);
export const safeParseTokenIdParams = (data: unknown) => tokenIdParamsSchema.safeParse(data);
export const safeParseContractAddressParams = (data: unknown) => contractAddressParamsSchema.safeParse(data);
export const safeParseWalletAddressParams = (data: unknown) => walletAddressParamsSchema.safeParse(data);
export const safeParseBlockchainBalance = (data: unknown) => blockchainBalanceSchema.safeParse(data);