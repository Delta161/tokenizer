...
export const ActionTypeEnum = z.enum(actionTypeValues);
...
// Ensure the inferred type matches the AuditLogFilter interface
...
// This ensures compatibility with the AuditLogFilter interface
