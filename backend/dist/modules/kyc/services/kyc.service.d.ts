...
import { KycSubmissionData, KycUpdateData, KycRecordWithUser } from '../types/kyc.types.js';
...
export declare class KycService {
     ...
     */
    initiateProviderVerification(userId: string, provider: KycProvider, redirectUrl: string): Promise<import("../provider/kycProvider.types.js").KycProviderSession>;
    /**
