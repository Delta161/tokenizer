...
import { googleCallback, azureCallback, logout, getCurrentUser, refreshToken, authHealthCheck, handleAuthError } from './auth.controller.js';
 ...
 * GET /auth/azure
 */
router.get('/azure', passport.authenticate('azure-ad', azureAuthOptions));
/**
 ...
 */
router.get('/azure/callback', passport.authenticate('azure-ad', {
    failureRedirect: azureCallbackOptions.failureRedirect,
    session: false
}), azureCallback);
/**
...
router.get('/error', (req, res) => {
    const error = req.query.error || 'Unknown authentication error';
