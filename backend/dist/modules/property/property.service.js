...
export class PropertyService {
    ...
    async getMyProperties(clientId) {
    ...
    async update(clientId, id, dto) {
        ...
        if (!property || property.clientId !== clientId || property.status === PropertyStatus.APPROVED)
            return null;
