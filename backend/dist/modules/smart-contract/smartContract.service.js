...
import { TransactionStatus } from './types/smartContract.types.js';
import { validateAddress, loadContractABI, resolveArtifactPath, validateTxHash, formatTokenAmount } from './utils/contract.utils.js';
dotenv.config();
export class SmartContractService {
     ...
     */
    async getBalanceOf(address, userWallet) {
    ...
    subscribeToEvent(address, eventName, callback) {
        ...
        return () => {
            ...
            this.eventListeners = this.eventListeners.filter(l => l.contract !== contract || l.eventName !== eventName || l.listener !== callback);
        };
    }
    /**
