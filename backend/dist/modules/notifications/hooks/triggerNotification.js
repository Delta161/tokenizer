...
export class NotificationTrigger {
     ...
     */
    async triggerNotification(userId, type, title, message, metadata) {
        try {
   ...
   */
    async triggerBroadcast(adminId, type, title, message, metadata) {
        try {
 ...
 */
export function createNotificationTrigger(prisma, config) {
