...
import { NotificationType, createNotificationTrigger, NotificationDispatcherService, EmailNotificationChannel } from '../index';
/**
...
async function basicNotificationExample() {
    ...
    try {
        ...
        const notificationId = await notificationTrigger.triggerNotification('user-123', // userId
        ...
        const broadcastResult = await notificationTrigger.triggerBroadcast('admin-456', // adminId
        NotificationType.SYSTEM, // notification type
...
//# sourceMappingURL=notification-delivery-example.js.map