...
import { NotificationType, initNotificationModule } from '../index';
/**
...
async function customConfigExample() {
    ...
    try {
        ...
        const notificationId = await trigger.triggerNotification('user-123', // userId
        ...
        const broadcastResult = await trigger.triggerBroadcast('admin-456', // adminId
...
async function channelToggleExample() {
    ...
    try {
        ...
        'This notification uses dynamically configured channels');
        console.log(`Notification triggered with ID: ${notificationId}`);
    }
    catch (error) {
...
//# sourceMappingURL=notification-config-example.js.map