...
import { AuthenticatedRequest } from '../../auth/middleware/requireAuth.js';
export declare class AdminController {
     ...
     * Get token by ID
     */
    getTokenById: (req: AuthenticatedRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
    /**
