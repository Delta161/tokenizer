 ...
 */
export function mapWalletToPublicDTO(wallet) {
    return {
        id: wallet.id,
 ...
 */
export function mapWalletsToPublicDTOs(wallets) {
 ...
 */
export function mapInvestorToPublicDTO(investor) {
    return {
        id: investor.id,
 ...
 */
export function mapInvestorsToPublicDTOs(investors) {
 ...
 */
export function isInvestorVerified(investor) {
 ...
 */
export function hasRequiredVerificationFields(investor) {
    return !!(investor.nationality &&
        investor.country &&
        investor.address &&
        investor.city &&
        investor.postalCode &&
 ...
 */
export function isWalletVerified(wallet) {
    return wallet.isVerified === true;
}
//# sourceMappingURL=investor.mapper.js.map