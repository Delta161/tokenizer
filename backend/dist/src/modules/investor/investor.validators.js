...
export const parseInvestorApplication = (data) => {
    return investorApplicationSchema.safeParse(data);
};
export const parseInvestorUpdate = (data) => {
    return investorUpdateSchema.safeParse(data);
};
export const parseInvestorVerificationUpdate = (data) => {
    return investorVerificationUpdateSchema.safeParse(data);
};
export const parseWalletCreate = (data) => {
    return walletCreateSchema.safeParse(data);
};
export const parseWalletVerificationUpdate = (data) => {
    return walletVerificationUpdateSchema.safeParse(data);
};
export const parseInvestorIdParam = (data) => {
    return investorIdParamSchema.safeParse(data);
};
export const parseWalletIdParam = (data) => {
    return walletIdParamSchema.safeParse(data);
};
export const parseInvestorListQuery = (data) => {
    return investorListQuerySchema.safeParse(data);
};
//# sourceMappingURL=investor.validators.js.map