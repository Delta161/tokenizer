import { mapInvestorToPublicDTO, mapInvestorsToPublicDTOs, mapWalletToPublicDTO } from './investor.mapper.js';
export class InvestorService {
     ...
     */
    async applyAsInvestor(userId, dto) {
     ...
     * @returns The updated investor profile
     */
    async updateInvestorVerification(id, dto) {
        const investor = await this.prisma.investor.update({
            where: { id },
            data: {
     ...
     */
    async addWallet(investorId, dto) {
     ...
     */
    async updateWalletVerification(walletId, dto) {
     ...
     */
    async canUserApplyAsInvestor(userId) {
        const investor = await this.prisma.investor.findUnique({
            where: { userId }
        });
        return !investor;
