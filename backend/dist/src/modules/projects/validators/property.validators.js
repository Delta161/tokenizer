...
export const createPropertySchema = z.object({
    ...
    tokensAvailablePercent: numericString('Tokens available percent must be a positive number').refine((val) => Number(val) > 0 && Number(val) <= 100, 'Tokens available percent must be between 0 and 100'),
...
export const updatePropertySchema = z.object({
    ...
    totalPrice: numericString('Total price must be a positive number').refine((val) => Number(val) > 0, 'Total price must be greater than 0').optional(),
    tokenPrice: numericString('Token price must be a positive number').refine((val) => Number(val) > 0, 'Token price must be greater than 0').optional(),
    irr: numericString('IRR must be a positive number').refine((val) => Number(val) > 0, 'IRR must be greater than 0').optional(),
    apr: numericString('APR must be a positive number').refine((val) => Number(val) > 0, 'APR must be greater than 0').optional(),
    valueGrowth: numericString('Value growth must be a positive number').refine((val) => Number(val) > 0, 'Value growth must be greater than 0').optional(),
    minInvestment: numericString('Minimum investment must be a positive number').refine((val) => Number(val) > 0, 'Minimum investment must be greater than 0').optional(),
    tokensAvailablePercent: numericString('Tokens available percent must be a positive number').refine((val) => Number(val) > 0 && Number(val) <= 100, 'Tokens available percent must be between 0 and 100').optional(),
