...
import { createPropertySchema, updatePropertySchema, updatePropertyStatusSchema, propertyIdParamSchema, propertyFilterSchema } from '../validators/property.validators';
export class PropertyController {
     ...
     */
    getPublicProperties = async (req, res) => {
        try {
            // Validate query parameters
            const queryValidation = propertyFilterSchema.safeParse(req.query);
            if (!queryValidation.success) {
