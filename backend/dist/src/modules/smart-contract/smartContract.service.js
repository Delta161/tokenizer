...
import { TransactionStatus } from './smartContract.types.js';
import { validateAddress, loadContractABI, resolveArtifactPath, validateTxHash, formatAmount } from './smartContract.utils.js';
dotenv.config();
export class SmartContractService {
    ...
    subscribeToEvent(address, eventName, callback) {
        ...
        return () => {
            ...
            this.eventListeners = this.eventListeners.filter(l => l.eventName !== eventName || l.callback !== callback);
        };
    }
    /**
