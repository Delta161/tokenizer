...
export class KycProviderController {
  constructor(private kycProviderService: KycProviderService) {}
  ...
  initiateVerification = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const session = await this.kycProviderService.initVerification(
        userId,
  ...
  handleWebhook = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const verificationResult = this.kycProviderService.verifyWebhookSignature(
        provider as KycProvider,
      ...
      const updatedRecord = await this.kycProviderService.processWebhook(
        provider as KycProvider,
