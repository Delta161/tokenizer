...
import { NotificationChannel, createNotificationChannels } from './channels';
import { notificationLogger } from '../utils/notifications.logger';
import { NotificationConfig, defaultNotificationConfig } from '../config/notification.config';
...
export class NotificationDispatcherService {
   ...
   */
  async dispatchNotification(user: UserPublicDTO, notification: NotificationDto): Promise<void> {
   ...
   */
  registerChannel(channel: NotificationChannel, enabled = true): void {
   ...
   */
  private getChannelConfig(channelId: string): NotificationChannelConfig | undefined {
    switch (channelId) {
      case 'in-app':
